...
public class UserServiceTest {
    ...
    @Test
    public void testSearchByUsername() throws UserNotFound {
        UserService userService = new UserService(userRepository);
        List<User> userList = new ArrayList<>();
        when(userRepository.findByUsernameContaining("John")).thenReturn(Optional.of(userList));
        List<User> actual = userService.searchByUsername("John");
        Assert.assertEquals(actual, userList);
    }

    @Test(expected = UserNotFound.class)
    public void testSearchByUsernameFail() throws UserNotFound {
        UserService userService = new UserService(userRepository);
